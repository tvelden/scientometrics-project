...
library(shape)
library(rgdal)
world.shp <- readShapePoly(file.choose(),proj4string=CRS("+proj=longlat"))

final_coordinates <- read.csv("C:\\Users\\Sneha\\scientometrics-project\\organic_chemistry.csv")
...
title("Geographic overlay map",sub="Equal-Interval Class Intervals")
